...
public static RemoteObject  _btnhelloworld_click() throws Exception{
try {
		Debug.PushSubsStack("BtnHelloWorld_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,43);
if (RapidSub.canDelegate("btnhelloworld_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnhelloworld_click");}
 BA.debugLineNum = 43;BA.debugLine="Sub BtnHelloWorld_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 44;BA.debugLine="Msgbox(\"HellWorld\",\"Message\")";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence("HellWorld")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Message"))),main.mostCurrent.activityBA);
...
main.mostCurrent._btnhelloworld = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
