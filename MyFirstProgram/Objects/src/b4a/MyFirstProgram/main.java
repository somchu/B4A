...
RDebugUtils.currentLine=131075;
 //BA.debugLineNum = 131075;BA.debugLine="Activity.LoadLayout(\"Mail\")";
mostCurrent._activity.LoadLayout("Mail",mostCurrent.activityBA);
RDebugUtils.currentLine=131076;
 //BA.debugLineNum = 131076;BA.debugLine="NewProblem";
_newproblem();
RDebugUtils.currentLine=131077;
 //BA.debugLineNum = 131077;BA.debugLine="End Sub";
return "";
}
public static String  _newproblem() throws Exception{
RDebugUtils.currentModule="main";
if (Debug.shouldDelegate(mostCurrent.activityBA, "newproblem", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "newproblem", null));}
RDebugUtils.currentLine=196608;
 //BA.debugLineNum = 196608;BA.debugLine="Sub NewProblem";
RDebugUtils.currentLine=196609;
 //BA.debugLineNum = 196609;BA.debugLine="Number1 = Rnd(1,10)";
_number1 = anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (10));
RDebugUtils.currentLine=196610;
 //BA.debugLineNum = 196610;BA.debugLine="Number2 = Rnd(1,10)";
_number2 = anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (10));
RDebugUtils.currentLine=196611;
 //BA.debugLineNum = 196611;BA.debugLine="LblNumber1.Text  = Number1";
mostCurrent._lblnumber1.setText(BA.ObjectToCharSequence(_number1));
RDebugUtils.currentLine=196612;
 //BA.debugLineNum = 196612;BA.debugLine="LblNumber2.Text = Number2";
mostCurrent._lblnumber2.setText(BA.ObjectToCharSequence(_number2));
RDebugUtils.currentLine=196613;
 //BA.debugLineNum = 196613;BA.debugLine="LblComment.Text = \"Enter the Result \" & CRLF & \"";
mostCurrent._lblcomment.setText(BA.ObjectToCharSequence("Enter the Result "+anywheresoftware.b4a.keywords.Common.CRLF+" and click OK"));
RDebugUtils.currentLine=196614;
 //BA.debugLineNum = 196614;BA.debugLine="EdtResult.Text = \"\"";
mostCurrent._edtresult.setText(BA.ObjectToCharSequence(""));
...
RDebugUtils.currentLine=393224;
 //BA.debugLineNum = 393224;BA.debugLine="NewProblem";
_newproblem();
...
RDebugUtils.currentLine=458754;
 //BA.debugLineNum = 458754;BA.debugLine="LblComment.Text = \"G o o d....Result \"& CRLF & \"";
mostCurrent._lblcomment.setText(BA.ObjectToCharSequence("G o o d....Result "+anywheresoftware.b4a.keywords.Common.CRLF+"Click on NEW"));
...
RDebugUtils.currentLine=458757;
 //BA.debugLineNum = 458757;BA.debugLine="LblComment.Text = \"W R O N G result\" & CRLF & \"E";
mostCurrent._lblcomment.setText(BA.ObjectToCharSequence("W R O N G result"+anywheresoftware.b4a.keywords.Common.CRLF+"Enter a new result"+anywheresoftware.b4a.keywords.Common.CRLF+"and click OK"));
 };
