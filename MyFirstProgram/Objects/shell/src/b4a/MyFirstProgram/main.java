...
public static RemoteObject _lblcomment = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _number2 = RemoteObject.createImmutable(0);
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"BtnAction",main.mostCurrent._btnaction,"EdtResult",main.mostCurrent._edtresult,"LblComment",main.mostCurrent._lblcomment,"LblMathSign",main.mostCurrent._lblmathsign,"LblNumber1",main.mostCurrent._lblnumber1,"LblNumber2",main.mostCurrent._lblnumber2,"Number1",main._number1,"Number2",main._number2};
}
}